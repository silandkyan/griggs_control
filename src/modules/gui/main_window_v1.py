...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.quitButton.setStyleSheet("QPushButton{background-color: rgb(200, 50, 0);}")
        ...
        self.pushB_update_const.setGeometry(QtCore.QRect(20, 250, 91, 31))
        ...
        self.pushB_set_closed.setGeometry(QtCore.QRect(270, 290, 101, 41))
        self.pushB_set_closed.setObjectName("pushB_set_closed")
        self.pushB_close_valve = QtWidgets.QPushButton(self.tab)
        self.pushB_close_valve.setGeometry(QtCore.QRect(10, 290, 131, 41))
        ...
        self.label_s3 = QtWidgets.QLabel(self.tab)
        self.label_s3.setGeometry(QtCore.QRect(150, 300, 91, 21))
        ...
        self.pushB_update_quench.setGeometry(QtCore.QRect(20, 250, 91, 31))
        ...
        self.label.setGeometry(QtCore.QRect(420, 190, 441, 231))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushB_multi_up_s3.setText(_translate("MainWindow", "step open"))
        self.pushB_stop_s3.setText(_translate("MainWindow", "stop"))
        self.label_2.setText(_translate("MainWindow", "quench by "))
        self.pushB_perm_up_s3.setText(_translate("MainWindow", "perm open"))
        ...
        self.pushB_perm_down_s3.setText(_translate("MainWindow", "perm close"))
        ...
        self.label_s3.setText(_translate("MainWindow", "1000 / 1000 bar"))
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">General:</span></p><p>- get ADC prints adc value and voltage of σ<span style=\" font-size:9pt; vertical-align:sub;\">1 </span><span style=\" font-size:9pt;\">l</span>oadcell and σ<span style=\" vertical-align:sub;\">3 </span>oilpressure</p><p>in console</p><p><span style=\" font-size:10pt;\">For Quenching: </span></p><p>- prequench rpm: to open valve until oilpressure changes (fast)</p><p>- quench rpm: to open the valve all the way open (slow)</p><p>(target position := valve all the way opened)</p><p>- dsigma setpoint is the const. diff. stress [Mpa] </p><p>s1 establishes via PID as a passive reaction on s3 action<br/></p></body></html>"))
