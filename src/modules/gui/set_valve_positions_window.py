...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lcd_current_1.setGeometry(QtCore.QRect(330, 60, 81, 23))
        self.lcd_current_1.setDigitCount(6)
        ...
        self.lcd_stored_1A.setGeometry(QtCore.QRect(430, 60, 81, 23))
        self.lcd_stored_1A.setDigitCount(6)
        ...
        self.lcd_stored_1B.setGeometry(QtCore.QRect(530, 60, 81, 23))
        self.lcd_stored_1B.setDigitCount(6)
        ...
        self.pushB_get_position = QtWidgets.QPushButton(self.centralwidget)
        self.pushB_get_position.setGeometry(QtCore.QRect(440, 230, 151, 51))
        self.pushB_get_position.setObjectName("pushB_get_position")
        self.pushB_set_opened = QtWidgets.QPushButton(self.centralwidget)
        self.pushB_set_opened.setGeometry(QtCore.QRect(50, 300, 121, 41))
        self.pushB_set_opened.setObjectName("pushB_set_opened")
        self.pushB_set_closed = QtWidgets.QPushButton(self.centralwidget)
        self.pushB_set_closed.setGeometry(QtCore.QRect(220, 300, 121, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushB_get_position.setText(_translate("MainWindow", "get position"))
        self.pushB_set_opened.setText(_translate("MainWindow", "set opened "))
        self.pushB_set_closed.setText(_translate("MainWindow", "set closed"))
